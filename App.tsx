...
import { polishCVWithNvidia } from './services/nvidia';
...
const App: React.FC = () => {
  ...
  const handlePolish = async () => {
    ...
    setError(null);
    try {
      const polishedData = await polishCVWithNvidia(cvData);
        ...
        <div className="w-full max-w-[210mm]">
          ...
          <div className="hidden xl:flex fixed bottom-8 right-8 bg-white p-4 rounded-xl shadow-lg border border-gray-200 max-w-xs animate-slide-up">
            <div className="flex gap-3">
              ...
              <div>
                <h4 className="font-bold text-gray-900 text-sm">Powered by NVIDIA z-ai/glm4.7</h4>
